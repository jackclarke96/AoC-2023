...
This will mean fewer lookups on pipes to see if they have been traversed.

After this, use the ray-cast method on each row to determine number of boundaries crossed. 

Each time a boundary is encountered:
