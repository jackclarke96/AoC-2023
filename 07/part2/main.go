...
// part 2: J Should have lowest score. Change cardToScoreMap to reflect this
// Also, if J exists, it should basically be updated to match the card which appears most frequently, but the cardScores should remain untouched
